...
[_QWERTY] = LAYOUT_ortho( \
      ...
      KC_ESC,   KC_A,       KC_S,       KC_D,       KC_F,   KC_G,   KC_H,    KC_J,      KC_K,    KC_L,      KC_SCLN, KC_QUOT, KC_PGUP, \
      KC_LSFT,  KC_X,       KC_Z,       KC_C,       KC_V,   KC_B,   KC_N,    KC_M,      KC_COMM, KC_DOT,    KC_SLSH, KC_UP, KC_ENT, \
      _LOWER,   KC_LCTL,    KC_LGUI,    KC_LALT,    KC_SPC, _RAISE, _ADJUST, _______,   KC_LEFT, KC_DOWN,   KC_RGHT \
),
