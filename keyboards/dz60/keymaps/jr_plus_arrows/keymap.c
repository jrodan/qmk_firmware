 ...
 */
  ...
  LAYOUT_directional(
      ...
      KC_LSFT,         KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, MT(MOD_RSFT, KC_SLSH), KC_UP, KC_DEL,
 ...
 */
  ...
  LAYOUT_directional(
        ...
        _______, KC_F14, KC_F15, LCTL(KC_UP), KC_F12, KC_F13, _______, _______, _______, _______, _______, _______, _______, _______, KC_F24, \
        _______, RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, _______, _______, _______,         _______, \
        _______,    BL_TOGG, BL_DEC, BL_INC, BL_STEP, _______, _______, _______, KC__VOLDOWN, KC__VOLUP,      KC_MUTE, KC_PGUP, KC_HOME, _______, \
        _______, _______, _______,                   _______,                    _______, _______, _______, _______, KC_PGDOWN, KC_END),
