...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_BASE] = LAYOUT_60_ansi(
		...
		MO(_ARR),          KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,
		KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,          KC_RSFT,
		KC_LCTL, KC_LGUI,          KC_LALT,                   KC_SPC,                             MO(_FN), KC_RALT, KC_RGUI,   KC_RCTL
        ),
    ...
    [_ARR] = LAYOUT_60_ansi(
		...
		_______, KC_UP, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
