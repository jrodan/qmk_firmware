...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT( \
        ...
        ARROW, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, KC_ENT, \
    ...
    [1] = LAYOUT( \
        ...
        _______, KC_F14, KC_F15, LCTL(KC_UP), KC_F12, KC_F13, _______, _______, _______, _______, _______, _______, _______, KC_F24, \
        ...
        _______, _______, _______,                   _______,                    _______, _______, _______, KC_PGDOWN, KC_END),
    [2] = LAYOUT( \
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
        KC_LSFT, _______, KC_UP, _______, _______, _______, _______, _______, _______, _______, KC_UP, _______, _______, _______, \
        _______, KC_LEFT, KC_DOWN, KC_RIGHT, _______, _______, _______, _______, _______, KC_LEFT, KC_DOWN, KC_RIGHT,         _______, \
